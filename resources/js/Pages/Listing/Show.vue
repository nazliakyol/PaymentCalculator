...
import MakeOffer from "@/Pages/Listing/Show/Component/MakeOffer.vue";
...
const { totalPaid } = useMonthlyPayment(offer, interestRate, duration);
const { totalInterest } = useMonthlyPayment(offer, interestRate, duration);
const page = usePage();
const user = computed(
    () => page.props.user
);
