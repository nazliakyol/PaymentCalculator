...
const { totalPaid } = useMonthlyPayment(props.listing.price, interestRate, duration);
const { totalInterest } = useMonthlyPayment(props.listing.price, interestRate, duration);
